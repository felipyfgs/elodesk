---
description: Run a full quality review on the Go backend — lint, format, tests, error handling, logging, security and code patterns — and auto-fix everything possible
---
