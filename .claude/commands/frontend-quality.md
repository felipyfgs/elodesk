...
description: Quality review Nuxt frontend — lint --fix, typecheck, i18n parity (pt-BR + en), Pinia store naming, composable hygiene. Auto-fixes everything possible.
allowed-tools: Bash(cd frontend:*), Bash(pnpm:*), Grep, Glob, Read, Edit
---
