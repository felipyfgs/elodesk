---
name: "full-test"
description: Run full test suite — Go backend (-race + coverage) and Nuxt frontend (tests, typecheck, lint). Reports combined pass/fail.
allowed-tools: Bash(cd backend:*), Bash(cd frontend:*), Bash(go:*), Bash(pnpm:*), Bash(golangci-lint:*), Read
---
