...
description: Use when adding or modifying files under backend/migrations/*.sql, altering schema, or questioning migration safety. Covers NNNN_description naming, IF NOT EXISTS idempotency, required account_id tenant scope, created_at/updated_at columns and go:embed directive. Forward-only — never rollback.
license: MIT
---
