...
import { whatsappStepSetupSchema, whatsappStepCredentialsSchema, type WhatsAppInboxForm } from '~/schemas/inboxes/whatsapp'
...
const state = reactive<WhatsAppInboxForm>({
  name: '',
    ...
    <UStepper v-model="step" :items="stepperItems" :linear="true">
      <template #setup="{}">
        <UPageCard variant="subtle">
          <UForm
            ref="setupFormRef"
            :schema="whatsappStepSetupSchema"
            :state="state"
          ...
          >
            ...
            <UFormField :label="t('inboxes.wizards.whatsapp.phoneNumber')" name="phoneNumber" required>
      ...
      <template #credentials="{}">
        <UPageCard variant="subtle">
          <UForm
            ...
            :schema="whatsappStepCredentialsSchema"
            :state="state"
            class="flex flex-col gap-4"
          >
            <UFormField :label="t('inboxes.wizards.whatsapp.phoneNumberId')" name="phoneNumberId">
              <UInput v-model="state.phoneNumberId" />
            </UFormField>

            <UFormField :label="t('inboxes.wizards.whatsapp.businessAccountId')" name="businessAccountId">
              <UInput v-model="state.businessAccountId" />
            </UFormField>

            <UFormField :label="t('inboxes.wizards.whatsapp.apiKey')" name="apiKey" required>
              <UTextarea v-model="state.apiKey" :rows="3" />
            </UFormField>
          </UForm>
        </UPageCard>
      </template>
