...
func (s *Server) SetupRoutes(cfg *config.Config, db *database.DB, redisClient *redis.Client) (*asynq.Client, error) {
	...
	accounts.Get("/inboxes/:id", inboxHandler.FindByID)
	...
	accounts.Get("/inboxes/:id/whatsapp", agentPlus, whatsAppInboxHandler.FindByID)
	...
	accounts.Get("/inboxes/web_widget/:id", agentPlus, widgetInboxHandler.FindByInboxID)
	...
	accounts.Get("/inboxes/:id/line", agentPlus, lineWebhookHandler.FindByInboxID)
	...
	accounts.Get("/inboxes/:id/tiktok", agentPlus, tiktokHandler.FindByInboxID)
	...
	accounts.Get("/inboxes/:id/twilio", agentPlus, twilioWebhookHandler.FindByInboxID)
	...
	accounts.Get("/inboxes/:id/twitter", agentPlus, twitterHandler.FindByInboxID)
